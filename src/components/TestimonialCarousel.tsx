      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {testimonials.map((test, idx) => (
          <div key={idx} className="w-full h-full">
            <div className="playful-card border-4 border-yellow-300 rounded-[32px] p-6 bg-amber-50/30 flex flex-col shadow-sm h-full hover:scale-105 transition-transform duration-300">
